...
function initCommentEvent() {
    ...
    function reply(box) {
        var replyId = 0;
        //获取用户姓名和联系方式
        var name = box.getElementsByClassName("form-control")[0].value;
        var contactInfo = box.getElementsByClassName("form-control")[1].value;
        if(!name || !contactInfo ){
    ...
    for (var i = 0; i < lists.length; i++) {
        ...
        textarea.onblur = function() {
            if (this.value == '') {
                $(this).siblings(".row").addClass("hidden");
        ...
        textarea.onkeyup = function() {
            ...
            if (len == 0 /*|| len>100*/ ) {
                ...
                $(this).siblings(".row").removeClass("hidden");
